  ...
  <div className="max-w-7xl mx-auto px-4">
    <div className="flex items-center justify-between h-16">
      ...
      <div className="flex space-x-4 text-white">
        ...
        <Link className={path === "/dashboard/notes" ? "active" : "hidden md:block"}  href="/dashboard/notes">Notes📝</Link>
        <Link className={path === "/dashboard/youtube" ? "active" : "hidden md:block"} href="/dashboard/youtube">Lecture📺</Link>
        <Link className={path === "/dashboard/problem" ? "active" : "hidden md:block"} href="/dashboard/problem">Problem❓</Link>
        <Link className={path === "/dashboard/cheatsheet" ? "active" : "hidden md:block"}href="/dashboard/cheatsheet">Cheatsheet📒</Link>
        <Link className={path === "/dashboard/posturechecker" ? "active" : "hidden md:block"}href="/dashboard/posturechecker">PostureCheaker🧘</Link>
